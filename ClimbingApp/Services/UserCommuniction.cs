...
public class UserCommuniction : UserCommunicationBase, IUserCommunication
{
    ...
    //public delegate void HighRatingDelegate(object sender, Route route);
    //public event HighRatingDelegate HighRating;
    //public event EventHandler<Route> HighRating;

    public UserCommuniction(
